...
\end{itemize}
  \begin{center}
  \includegraphics[width=\linewidth, height=3.0cm, keepaspectratio]{v2_rural.png}\\
  {\small V2 -- rural (antes dos ajustes)}
  \end{center}
\column{0.48\textwidth}
...
\end{itemize}
  \begin{center}
  \includegraphics[width=\linewidth, height=2.8cm, keepaspectratio]{v2_rural_ajustes.png}\\
  {\small V2 -- rural (após ajustes)}
  \end{center}
\end{columns}
\end{frame}

\begin{frame}[t]{Versão 2 -- Urbano e Melhoria do Grafo}
\scriptsize
\begin{columns}[T,onlytextwidth]
\column{0.48\textwidth}
\textbf{Cena urbana após ajustes:}
\begin{itemize}
  \item Parâmetros ajustados para rural não generalizaram para urbano
  \item Máscara quase vazia: quase nenhuma via detectada
  \item Telhados e estacionamentos amplificam os falsos positivos
\end{itemize}
  \begin{center}
  \includegraphics[width=\linewidth, height=2.8cm, keepaspectratio]{v2_urbana_ajustes.png}\\
  {\small V2 -- urbana (péssima generalização)}
  \end{center}
\column{0.48\textwidth}
\textbf{Melhoria do algoritmo de grafo:}
\begin{itemize}
  \item Testado no urbano inicial (máscara mais densa -- 23{,}5\% vias)
  \item Antes: esqueleto inteiro resultava em 1 único subgrafo conectado
  \item Melhoria: subgrafo independente por componente conexo da máscara
  \item Após: N subgrafos gerados conforme regiões detectadas
\end{itemize}
  \begin{center}
  \includegraphics[width=\linewidth, height=2.5cm, keepaspectratio]{v2_rural_ajustes_grafos.png}\\
  {\small Após melhoria: múltiplos subgrafos por componente}
  \end{center}
\end{columns}
\end{frame}
