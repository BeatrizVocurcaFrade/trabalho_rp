...
\centering
\begin{tikzpicture}[
  box/.style={draw, rounded corners, fill=blue!10, text width=2.1cm,
              align=center, minimum height=0.85cm, font=\small},
  arr/.style={->, thick}
]
  \node[box] (pre)  at (0,0)    {Pré-\\processamento};
  \node[box] (det)  at (3.1,0)  {Detecção\\de vias};
  \node[box] (pos)  at (6.2,0)  {Pós-\\processamento};
  \node[box] (skel) at (9.3,0)  {Esqueleti-\\zação};
  \node[box] (graf) at (12.4,0) {Extração\\de grafo};
...
\bigskip
\centering\small Pré-processamento e detector evoluem a cada versão. \textbf{Prioridade:} qualidade da máscara -- grafo depende diretamente dela.
\end{frame}
...
\begin{frame}{Versão 1 -- Limitações}
\begin{columns}
\column{0.50\textwidth}
{\small
...
\end{columns}
\begin{alertblock}{\small Conclusão}
  {\small Necessário incorporar \textbf{informação estrutural} para discriminar vias de manchas de solo.}
\end{alertblock}
\end{frame}
...
\begin{frame}{Versão 2 -- Resultados Iniciais e Ajustes}
\begin{columns}
\column{0.48\textwidth}
{\small
...
\end{itemize}
  ...
  \includegraphics[width=\linewidth, keepaspectratio]{v2_rural.png}
...
\end{itemize}
  ...
  \includegraphics[width=\linewidth, keepaspectratio]{v2_rural_ajustes.png}
  \\\centering\small V2 -- rural (após ajustes)
\end{columns}
\end{frame}

\begin{frame}{Versão 2 -- Urbano e Tentativa de Grafo}
\begin{columns}
\column{0.48\textwidth}
{\small
...
\end{itemize}
  ...
  \includegraphics[width=\linewidth, keepaspectratio]{v2_urbana_ajustes.png}
...
\end{itemize}
  ...
  \includegraphics[width=\linewidth, keepaspectratio]{v2_rural_ajustes_grafos.png}
...
\[
  0{,}38\!\cdot\!\text{grayness} + 0{,}25\!\cdot\!(1\!-\!s) + 0{,}20\!\cdot\!\text{homog} + 0{,}17\!\cdot\!\text{linear}
\]
}
\column{0.48\textwidth}
{\small
...
\column{0.98\textwidth}
  \includegraphics[width=\linewidth, keepaspectratio]{v3_rural.png}
\end{columns}
{\small
\begin{columns}
...
\begin{frame}{Evolução das Versões}
\centering\small
\begin{tabular}{lccc}
\toprule
...
\bigskip
{\small \textbf{Prioridade} em todas as versões: melhorar a máscara.\\O grafo foi implementado e testado, mas sua qualidade é diretamente dependente da máscara -- com falsos positivos, o grafo fica fragmentado e sem valor semântico.}
\end{frame}
...
\begin{frame}{Lições e Conclusão}
\begin{columns}
\column{0.48\textwidth}
{\small
